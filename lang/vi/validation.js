export default {
  ...
  confirmed: `{{field}} phải khớp với '{{original}}'`,
  ...
  max: {
    ...
    string: '{{field}} không được vượt quá {{max}} ký tự.',
  ...
  min: {
    ...
    string: '{{field}} không được ít hơn {{min}} ký tự.',
  ...
  required_unless:
    'The {{field}} field is required unless {{other}} is in {{values}}.',
  required_with: 'The {{field}} field is required when {{values}} is present.',
  required_with_all:
    'The {{field}} field is required when {{values}} are present.',
  required_without:
    'The {{field}} field is required when {{values}} is not present.',
